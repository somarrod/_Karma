...
Per a una informació completa, consulta la [Guia per al desplegament del KarmaWebApi mitjançant Docker](Guia_Desplegament_KarmaWebApi_Docker.pdf), disponible en aquest mateix directori.
